export const worksData = [
  ...
  },
  {
    ...
    category: 'Training',
    description: '組織全体のデジタルリテラシー底上げのため、AI活用を中心とした全社的な社員研修プログラムを提供。',
    client: '株式会社スズキ、株式会社ユニバーサルエンターテインメント、ナツメアタリ株式会社、株式会社ASA、株式会社レックス、株式会社BSクリエイト、アイニチ株式会社、株式会社オフィスF南大阪、株式会社阪神メタリックス、株式会社楽笑、株式会社ASライジング、株式会社スクラム、株式会社ビザライ、NPO法人たんぽぽの丘、大阪IR&ウェディング・ホテル専門学校、岩谷産業株式会社、株式会社リンクスプラウト、株式会社住吉工務店、株式会社ウェッジ、株式会社サンワ、株式会社ZUND、株式会社トパック、三友工業株式会社、株式会社エイトビィ、株式会社オンデオマ、株式会社コープ葬祭、株式会社たなべの社、株式会社チンタイバンク、株式会社浅田鉄工、株式会社真栄産業 ほか多数',
    imageUrl: '/works/training1_new.jpg',
  },
  {
