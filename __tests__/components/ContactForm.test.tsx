...
describe('ContactForm', () => {
  it('renders all form fields', () => {
    render(<ContactForm />)
    expect(screen.getByLabelText(/お問い合わせ種別/i)).toBeInTheDocument()
  ...
  it('shows error messages on invalid submission', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/お問い合わせ種別を選択してください/i)).toBeInTheDocument()
  ...
  it('calls onSuccess on valid submission', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/お問い合わせ種別/i), { target: { value: 'ai_solution' } })
